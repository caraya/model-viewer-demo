 ...
 */
import { Box3, Color, DirectionalLight, HemisphereLight, Object3D, PerspectiveCamera, Scene, Vector3 } from 'three';
...
export default class ModelScene extends Scene {
    ...
    scaleModelToFitRoom() {
        ...
        let scale = Math.min(roomSize.x / modelSize.x, roomSize.y / modelSize.y, roomSize.z / modelSize.z);
        // @see ROOM_PADDING_SCALE
