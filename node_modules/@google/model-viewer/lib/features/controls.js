...
export const ControlsMixin = (ModelViewerElement) => {
    ...
    class ControlsModelViewerElement extends ModelViewerElement {
        constructor() {
            ...
            this[_f] = () => this[$onChange]();
            this[_g] = () => this[$onFocus]();
            this[_h] = () => this[$onBlur]();
            this[_j] = () => this[$onPromptTransitionend]();
        ...
        updated(changedProperties) {
            ...
            if (changedProperties.has('cameraOrbit')) {
                ...
                controls.setOrbit(theta, phi, radius);
            }
        }
        [(_a = $idleTime, _b = $userPromptedOnce, _c = $waitingToPromptUser, _d = $shouldPromptUserToInteract, _e = $lastSpherical, _f = $changeHandler, _g = $focusHandler, _h = $blurHandler, _j = $promptTransitionendHandler, $tick)](time, delta) {
